 ...
 *
 */
public class FacadeLuceneOld {
	
	private Logger logger =Logger.getLogger(FacadeLuceneOld.class);
	private static FacadeLuceneOld instance;
	private IndexerOld indexer;
	private Search searcher; 
	private String pathIndice;

	
	public static FacadeLuceneOld getInstance(){
		if(instance==null)
			instance=new FacadeLuceneOld("./index");
		return instance;
	}

	public FacadeLuceneOld(String pathIndice){
	...
	public void iniziaIndicizzazione() {
		...
		try {
			this.indexer= new IndexerOld(this.pathIndice);
		}catch(Exception e){
